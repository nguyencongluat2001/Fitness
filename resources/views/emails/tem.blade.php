                    ...
                    <tr>
                        <td align="center" valign="top"
                            ...
                            <a target="_blank" style="text-decoration: none;" href="{{ @$data['baseURL'] }}"><img
                                    ...
                                    src="https://fintopdata.vn/clients/img/LogoFinTop_red.png" width="50"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" align="center"
                                    ...
                                    <tr>
                                        <td valign="middle"
                                            ...
                                            background: #02ef2d6e;font-family: auto;color: #000000;"
                                            bgcolor="#E9703E">
                                                Mã xác thực OTP của bạn là: <span style="color:red">{{ @$data['otp'] }}</span> <br>
                                                Có hiệu lực trong vòng 30 phút <br>
                                                vui lòng không chia sẻ mã cho bất kỳ ai.<br>
                                                Xin cảm ơn! <br>
