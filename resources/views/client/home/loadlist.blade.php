...
<form id="frmSearchCP" role="form" action="" method="POST" style="width: 100%;overflow-x: scroll;">
    ...
    <table id="table-data" class="table  table-bordered table-condensed dataTable no-footer" style="background: #0000000d;" @if(!isset($_SESSION['id'])) onclick="window.location.href='/'" @endif>
        <colgroup>
            <col width="5%">
            <col width="6%"> <!-- macp -->
            <col width="6%"> <!-- san -->
