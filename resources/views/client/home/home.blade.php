                ...
                <form action="" method="POST" id="frmLoadlist_blog" style="background:#f1faff75;border-radius: 0.25em;">
                    ...
                    <div class="col-lg-6 mx-auto " style="display:flex">
                        <div class="input-group pt-2 box">
                                <input id="myInput" onkeyup="myFunction()"style="background:#ffcb59bd" type="text" class="input form-control form-control-lg rounded-pill rounded" placeholder="kiếm bài viết theo từ khóa...">
                        </div>
                    </div>
