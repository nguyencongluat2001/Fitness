                        ...
                        <div class="col-lg-12" style="  padding: 20px 50px 20px 50px;">
                            ...
                            <div class="py-2 px-3 row">
                                ...
                                <div class="col-md-4">
                                    <div class="customer_reviews px-3">
                                        <div class="icon"><i class="fas fa-quote-right"></i></div>
                                        <div style="color:#ffffff; text-align: justify;height: 460px;"class="pt-4 pb-3 text-content">“FINTOP là nơi tập hợp tinh hoa của đội ngũ chuyên gia trẻ, năng động, có kinh nghiệm thực chiến trên thị trường chứng khoán, vừa có kiến thức chuyên sâu về phân tích cơ bản và vừa có độ nhạy bén trong phân tích kỹ thuật.
