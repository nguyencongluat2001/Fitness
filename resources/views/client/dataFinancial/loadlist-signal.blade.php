    ...
    <table id="table-data" class="table  table-bordered table-striped table-condensed dataTable no-footer">
      ...
      <thead>
        ...
        <tr style="background:#529845;color:white">
          ...
          <td style="white-space: inherit;vertical-align: middle" align="center"><b>Vùng giá <br> cắt lỗ</b></td>
      ...
      <tbody id="body_data" style="background:#dbead3">
        ...
        <tr>
          ...
          <td style="vertical-align: middle;" class="td_stop_loss_price_zone_{{$id}}" align="center">
